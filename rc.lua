...
local global_keys = gears.table.join(
    ...
    awful.key({ modkey }, "r", function()
        awful.util.spawn_with_shell("j4-dmenu-desktop --dmenu=\"(cat ; (stest -flx $(echo $PATH | tr : ' ') | sort -u)) |\
        dmenu -i -p '' -fn 'FiraCode Nerd Font-12' -nf '#888888' -nb '#222222' -sf '#ffffff' -sb '#1688f0'\"")
    end),
